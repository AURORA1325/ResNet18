...
class my_Attention(nn.Module):
    def __init__(self, in_planes, ratio=32
        ...
        self.fc1   = nn.Conv2d(in_planes, in_planes // ratio, 2, bias=False)
        self.relu1 = nn.ReLU()
    ...
    def forward(self, x):
        avg_out = self.fc2(self.relu1(self.fc1(self.max_pool((self.avg_pool(x))))))
        #avg_out = self.fc2(self.relu1(self.fc1(self.max_pool((x)))))
        #max_out = self.fc2(self.relu1(self.fc1(self.max_pool(x))))

        #avg_out =self.bn1( self.fc2(self.relu1(self.fc1(self.max_pool((self.avg_pool(x)))))))
        out = avg_out 
...
class ResidualBlock(nn.Module):
    def __init__(self, in_channels, out_channels, stride=1, downsample=None):
        ...
        self.ca = my_Attention(out_channels)
...
# 数据载入
    ...
    return train_loss,train_erro,test_loss,test_erro
...
if __name__ == "__main__":
    train_loss,train_erro,test_loss,test_erro=ResNet_cbam()
    write_file(train_loss,train_erro,test_loss,test_erro,"my_attention")